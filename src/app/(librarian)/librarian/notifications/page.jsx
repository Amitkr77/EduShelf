      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4">
        {/* <div>
          ...
          <p className="text-sm sm:text-base text-[#6B7280] mt-1">
            Manage library alerts and system notifications.
            {unreadCount > 0 && (
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          >
            ...
            <SelectContent>
              ...
              <SelectItem value="new_book">New Book</SelectItem>
        ...
        <EmptyState
          ...
          description={
            filterType !== 'all'
              ...
              : "You're all caught up! Notifications will appear here when there are library activities."
          }
          actionLabel={
